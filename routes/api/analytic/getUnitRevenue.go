...
// @Produce json
// @Param aggregation query string false "Aggregation"
// @Param start_time query string false "Start Time in RFC3339 format (ex: 2023-06-01T08:00:00Z)"
// @Param end_time query string false "End Time in RFC3339 format (ex: 2023-06-01T08:00:00Z)"
...
func GetRevenue(c *fiber.Ctx) error {
	...
	// get revenue
	revenue, err := models.GetRevenue(tx, user.RentalID, req.StartTime, req.EndTime)
	if err != nil {
		tx.Rollback()
